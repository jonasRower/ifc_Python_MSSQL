...
class vytvorTabulky:
    ...
    def __init__(self, poleRozdelenychRadku):
        ...
        ####################################
        # tudy bezi stary kod - tisk do txt souboru
        poleIndexuAll = self.vratIndexyVsechnyIndexyRadkuProIfcClasses(ifcClasses, ifcClassesUniq)
        self.nazevTabulkyARadkyAll = self.seskupPoleRozdelenychRadkuDleTabulek(poleHashId, parametersArr, ifcClassesUniq, poleIndexuAll)
